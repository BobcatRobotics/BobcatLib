package org.Hardware.CTRE.Motors.Controls.MotionMagicDutyCycle;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final MotionMagicDutyCycle request;
    ...
    public TalonFXControlRequest(CANDeviceDetails details,
      ...
      // default voltage
      request = new MotionMagicDutyCycle(angleInRotations).withEnableFOC(enableFOC);
