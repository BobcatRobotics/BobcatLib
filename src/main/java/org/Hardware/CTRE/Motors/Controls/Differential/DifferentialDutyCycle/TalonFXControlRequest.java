package org.Hardware.CTRE.Motors.Controls.Differential.DifferentialDutyCycle;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final  DifferentialDutyCycle request;
    ...
    public TalonFXControlRequest(CANDeviceDetails details,
        ...
        // default voltage
        request = new DifferentialDutyCycle(0.0,rotations).withEnableFOC(enableFOC);
