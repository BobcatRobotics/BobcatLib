package org.Hardware.CTRE.Motors.Controls.MotionMagicVoltage;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
  ...
  private AngularAcceleration setPointAngularAcceleration;

  public TalonFXControlRequest(CANDeviceDetails details,
      TalonFXConfiguration config,
      FeedforwardController feedforwardController, boolean enableFOC, Angle angleInRotations, AngularVelocity Velocity, AngularAcceleration Acceleration, Velocity<AngularAccelerationUnit> Jerk) {
    super();
    ...
    // default voltage
    request = new MotionMagicVoltage(angleInRotations).withEnableFOC(enableFOC);
    setPointAngleInRotations = angleInRotations;
    setPointAngularVelocity = Velocity;
    setPointAngularAcceleration = Acceleration;
  }
