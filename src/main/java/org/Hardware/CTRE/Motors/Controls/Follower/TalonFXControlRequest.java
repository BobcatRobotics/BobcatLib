package org.Hardware.CTRE.Motors.Controls.Follower;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final  Follower request;

    public TalonFXControlRequest(CANDeviceDetails details,
            TalonFXConfiguration config,
            FeedforwardController feedforwardController, boolean enableFOC, int MasterID , boolean OpposeMasterDirection) {
        ...
        // default voltage
        request = new Follower(MasterID,OpposeMasterDirection).withOpposeMasterDirection(OpposeMasterDirection);
    }
