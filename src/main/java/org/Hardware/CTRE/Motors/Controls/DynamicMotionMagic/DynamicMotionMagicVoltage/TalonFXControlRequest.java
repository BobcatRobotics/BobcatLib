package org.Hardware.CTRE.Motors.Controls.DynamicMotionMagic.DynamicMotionMagicVoltage;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final  DynamicMotionMagicVoltage request;

    private double setpointRotations;

    public TalonFXControlRequest(CANDeviceDetails details,
            TalonFXConfiguration config,
            FeedforwardController feedforwardController, boolean enableFOC, Angle Position, AngularVelocity Velocity, AngularAcceleration Acceleration, Velocity<AngularAccelerationUnit> Jerk) {
        ...
        // default voltage
        request = new DynamicMotionMagicVoltage(Position, Velocity, Acceleration, Jerk).withEnableFOC(enableFOC);
    }
