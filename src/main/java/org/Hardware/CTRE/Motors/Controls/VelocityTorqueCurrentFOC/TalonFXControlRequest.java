package org.Hardware.CTRE.Motors.Controls.VelocityTorqueCurrentFOC;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final VelocityTorqueCurrentFOC request;
  ...
  private AngularVelocity setPointVelocity;
    ...
    public TalonFXControlRequest(CANDeviceDetails details,
        ...
        // default voltage
        request = new VelocityTorqueCurrentFOC(angularVelocity);
