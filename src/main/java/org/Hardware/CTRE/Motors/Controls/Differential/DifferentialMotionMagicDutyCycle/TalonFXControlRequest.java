package org.Hardware.CTRE.Motors.Controls.Differential.DifferentialMotionMagicDutyCycle;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final  DifferentialMotionMagicDutyCycle request;
    ...
    public TalonFXControlRequest(CANDeviceDetails details,
        ...
        // default voltage
        request = new DifferentialMotionMagicDutyCycle(0.0,rotations).withEnableFOC(enableFOC);
