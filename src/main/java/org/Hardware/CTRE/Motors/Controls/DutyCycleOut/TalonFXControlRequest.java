package org.Hardware.CTRE.Motors.Controls.DutyCycleOut;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    public TalonFXControlRequest(CANDeviceDetails details,
        ...
        // default voltage
        request = new DutyCycleOut(0.0).withEnableFOC(enableFOC);
    ...
    public void periodic() {
      // approach setpoint
      request.Output = setpointRotations;
      motor.setControl(request);
    }
}
