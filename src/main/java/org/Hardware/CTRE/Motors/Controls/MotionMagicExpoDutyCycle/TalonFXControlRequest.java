package org.Hardware.CTRE.Motors.Controls.MotionMagicExpoDutyCycle;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final MotionMagicExpoDutyCycle request;
    ...
    public TalonFXControlRequest(CANDeviceDetails details,
      ...
      // default voltage
      request = new MotionMagicExpoDutyCycle(angleInRotations).withEnableFOC(enableFOC);
