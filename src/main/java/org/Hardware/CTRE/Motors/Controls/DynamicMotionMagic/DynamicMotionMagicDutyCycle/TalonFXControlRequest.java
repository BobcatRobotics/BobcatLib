package org.Hardware.CTRE.Motors.Controls.DynamicMotionMagic.DynamicMotionMagicDutyCycle;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final  DynamicMotionMagicDutyCycle request;
    ...
    public TalonFXControlRequest(CANDeviceDetails details,
        ...
        // default voltage
        request = new DynamicMotionMagicDutyCycle(Position, Velocity, Acceleration, Jerk).withEnableFOC(enableFOC);
    }
