package org.Hardware.CTRE.Motors.Controls.Differential.DifferentialVoltage;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final  DifferentialVoltage request;
    ...
    public TalonFXControlRequest(CANDeviceDetails details,
        ...
        // default voltage
        request = new DifferentialVoltage(0.0,rotations).withEnableFOC(enableFOC);
    ...
    public void setPos(double posRotations) {
      request.TargetOutput = posRotations;
    ...
    public void periodic() {
      // approach setpoint
      request.TargetOutput = setpointRotations;
      motor.setControl(request);
    }
}
