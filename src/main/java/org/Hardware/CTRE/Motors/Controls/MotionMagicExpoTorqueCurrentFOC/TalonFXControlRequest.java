package org.Hardware.CTRE.Motors.Controls.MotionMagicExpoTorqueCurrentFOC;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final MotionMagicExpoTorqueCurrentFOC request;
    ...
    public TalonFXControlRequest(CANDeviceDetails details,
      ...
      // default voltage
      request = new MotionMagicExpoTorqueCurrentFOC(angleInRotations);
