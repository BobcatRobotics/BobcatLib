package org.Hardware.CTRE.Motors.Controls.MotionMagicTorqueCurrentFOC;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final MotionMagicTorqueCurrentFOC request;
    ...
    public TalonFXControlRequest(CANDeviceDetails details,
      ...
      // default voltage
      request = new MotionMagicTorqueCurrentFOC(angleInRotations);
