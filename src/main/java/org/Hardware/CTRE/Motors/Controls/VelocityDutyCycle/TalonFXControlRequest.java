package org.Hardware.CTRE.Motors.Controls.VelocityDutyCycle;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final VelocityDutyCycle request;
  ...
  private AngularVelocity setPointVelocity;
    ...
    public TalonFXControlRequest(CANDeviceDetails details,
        ...
        // default voltage
        request = new VelocityDutyCycle(angularVelocity).withEnableFOC(enableFOC);
