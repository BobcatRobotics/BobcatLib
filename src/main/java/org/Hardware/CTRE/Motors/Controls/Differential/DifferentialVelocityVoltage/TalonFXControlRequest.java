package org.Hardware.CTRE.Motors.Controls.Differential.DifferentialVelocityVoltage;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final  DifferentialVelocityVoltage request;
    ...
    public TalonFXControlRequest(CANDeviceDetails details,
        ...
        // default voltage
        request = new DifferentialVelocityVoltage(0.0,rotations).withEnableFOC(enableFOC);
