package org.Hardware.CTRE.Motors.Controls.MotionMagicVelocityTorqueCurrentFOC;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
  ...
  public TalonFXControlRequest(CANDeviceDetails details,
    ...
    // default voltage
    request = new MotionMagicVelocityTorqueCurrentFOC(angularVelocity).withEnableFOC(enableFOC);
