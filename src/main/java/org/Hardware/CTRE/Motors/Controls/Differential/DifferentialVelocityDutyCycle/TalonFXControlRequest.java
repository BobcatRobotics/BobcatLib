package org.Hardware.CTRE.Motors.Controls.Differential.DifferentialVelocityDutyCycle;
...
public class TalonFXControlRequest extends ControlBase implements ControlInterface {
    ...
    private final  DifferentialVelocityDutyCycle request;
    ...
    public TalonFXControlRequest(CANDeviceDetails details,
        ...
        // default voltage
        request = new DifferentialVelocityDutyCycle(0.0,rotations).withEnableFOC(enableFOC);
